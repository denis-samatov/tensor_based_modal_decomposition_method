...
class RealtimeMonitor:
    ...
    def compare_prediction_observation(self,
        ...
        metrics = {
            'relative_error': float(relative_error.item()) if hasattr(relative_error, 'item') else float(relative_error),
            'max_error': float(max_error.item()) if hasattr(max_error, 'item') else float(max_error),
            'mean_error': float(mean_error.item()) if hasattr(mean_error, 'item') else float(mean_error),
