...
algorithm_path = Path("/Users/denissamatov/Heriot-Watt/tensor-based-modal-decomposition-method/algorithm")
...
def load_brugge_data():
    ...
    data_dir = Path("/Users/denissamatov/Heriot-Watt/tensor-based-modal-decomposition-method/data/Brugge data")
