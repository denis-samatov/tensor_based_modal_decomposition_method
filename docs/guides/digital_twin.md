...
См. полный пример: `examples/applications/brugge_field/run_brugge_enhanced.py`
...
### Примеры
- Базовый: `examples/digital_twin/01_digital_twin_basic.py`
- Brugge: `examples/applications/brugge_field/run_brugge_enhanced.py`
