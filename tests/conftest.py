...
def sample_mesh_2d():
    ...
    return {"coordinates": coords, "connectivity": np.array(connectivity)}
...
def decomposition_config():
    ...
    return DecompositionConfig(ranks=[20, 10, 5], energy_threshold=0.95, verbose=False)
...
def sensor_config():
    ...
    return SensorPlacementConfig(n_sensors=30, verbose=False)
...
def reconstruction_config():
    ...
    return ReconstructionConfig(
        solver="admm", max_iterations=50, convergence_eps=1e-2, verbose=False
    )
