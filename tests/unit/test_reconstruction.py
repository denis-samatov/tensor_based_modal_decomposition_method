...
from TBMD.config import ReconstructionConfig, CompressiveSensingConfig
...
class TestTensorCompressiveSensing:
    ...
    def test_initialization(self, sample_spatial_modes, sample_measurements, reconstruction_config):
        ...
        Y[sensor_indices] = sample_measurements[:, 0] # Take one time slice or simplified 1D measurement 
