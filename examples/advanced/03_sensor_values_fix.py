...
def demonstrate_problem_and_solution():
    ...
    # Create test data.
    torch.randn(10, 10, 5, dtype=torch.float32)
...
def test_fixed_experiment():
    ...
    test_tensors = {"subject_1": torch.randn(10, 10, 3, dtype=torch.float32)}
...
def main():
    ...
    try:
        ...
        return {"fixed_sensor_values": fixed1, "experiment_result": df}
