...
from TBMD.core.decomposition import GeometryAwareDecompositionConfig as HOSVDConfig
...
from TBMD.core.reconstruction import GeometryAwareCSConfig as CSConfig
from TBMD.core.reconstruction import GeometryAwareTensorCS
from TBMD.core.sensor_placement import GeometricQRConfig as QRConfig
from TBMD.core.sensor_placement import GeometryAwareTensorQR
...
def main():
    ...
    Path(os.path.join(data_dir, "all_wells_exp_4.json"))
    ...
    train_data_dict, test_data_dict = split_data_in_memory_ordered(
        {subject_name: tensor_data}, train_ratio=0.8
    )
    ...
    qr_config = QRConfig(
        gradient_weight=0.5, proximity_weight=1.0, min_distance_factor=1.5, amplitude_weight=1.0
    )
